...
QString binl2hex(QList<int> binarray)
{
...
QString binl2b64(QString binarray){
...
{
(blks[i>>2])|=((str[i].unicode())&0xFF) <<((i%4) * 8);
}
int i = str.length();
blks[i>>2]|=0x80 <<((i%4) * 8);
